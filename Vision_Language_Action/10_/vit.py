...
Date: 2025-03-22 10:13:50
LastEditTime: 2025-03-28 16:44:59
'''
...
class PaliGemmaMultiModalProjector(nn.Module):
    '''
    Description: Multi-Modal Projector \\
    Input Size: [Batch_Size, Num_Patches, Embed_Dim] \\
    Output Size: [Batch_Size, Num_Patches, Projection_Dim]
    '''
    def __init__(
        self,
        config,
        ...
        layer = get_layer(
            use_quantize,
            use_lora,
            config.lora_r if use_lora else {},
            config.lora_dropout if use_lora else {},
        )
        self.linear = layer(
